...
export class GetOperatorStruct {
    ...
    @ApiProperty({
        type: [String],
        description: 'Массив внешних номеров оператора',
...
export class OperatorsPhones {
    @ApiProperty({
        type: [Phones],
        description: 'Массив данных об операторах и их номерах'
    })
    numbers: Phones[];
}
...
export class UpdateOperatorNumbersResult {
    @ApiProperty({
        type: [String],
        description: 'Массив внешних номеров которые были добавлены',
        example: '["71234567890","71234567890"]'
    })
    numbers: string[];
}
...
export class DeleteeOperatorNumbersResult {
    @ApiProperty({
        type: [String],
        description: 'Массив внешних номеров которые были удалены',
        example: '["71234567890","71234567890"]'
    })
    numbers: string[];
}