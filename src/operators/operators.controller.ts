...
export class OperatorsController {
    ...
    @ApiBearerAuth()
    @ApiOperation({
        summary: 'Получение данных об операторах и их номерах'
    })
    @ApiOkResponse({
    ...
    @ApiBearerAuth()
    @ApiOperation({
        summary: 'Получение данных по номерам оператора'
    })
    @ApiParam({
        name: 'operatorName',
        enum: OperatorsName,
    ...
    @ApiBearerAuth()
    @ApiOperation({
        summary: 'Добавление внешних номеров оператора'
    })
    @ApiBody({
        type: OperatorsNumberDTO
    })
    @ApiParam({
        name: 'operatorName',
        enum: OperatorsName,
    ...
    @ApiBearerAuth()
    @ApiOperation({
        summary: 'Удаление внешних номеров оператора'
    })
    @ApiBody({
        type: OperatorsNumberDTO
    })
