...
export class OperatorsService {
    ...
    public async getOperator(operatorName: OperatorsName): Promise<Operators> {
        ...
        return await this.operatorsModel.findOne({
            name: operatorName
        });
    ...
    public async resetNumbersCounts(operatorName: OperatorsName): Promise<void> {
    ...
    public async getOperatorNumberInfo(operatorName: OperatorsName): Promise<GetOperatorStruct> {
        ...
        const result = await this.operatorsModel.findOne({
            name: operatorName
        }, OPERATOR_PROJ);
    ...
    private async operatorNumbersInfo(operatorName: OperatorsName): Promise<OperatorNumbersInfo> {
        ...
        const operator = await this.operatorsModel.findOne({
            name: operatorName
        });
