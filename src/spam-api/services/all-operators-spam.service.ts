...
export class AllOperatorsSpamService {
    ...
    private async _checkAllOperators(defaultApiStruct: DefaultApplicationApiStruct, operatorsName: OperatorsName[]): Promise<void> {
        try {
    ...
    private async addCheckSpamId(defaultApiStruct: DefaultApplicationApiStruct, applicationId: string): Promise<void> {
        ...
        !!allOperatorsCheck.applicationIds ? applicationIds.push(...allOperatorsCheck.applicationIds, applicationId) : applicationIds.push(applicationId);
